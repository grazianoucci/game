...
# TODO: fix import from sklearn.model_selection import cross_val_score
...
def run_game(
        manual_input=False, filename_int='input/inputs_game_test.dat'
        , filename_err='input/errors_game_test.dat',
        filename_library='input/labels_game_test.dat', choice_rep=YES
        , n_processes=2, n_repetition=10000, dir_path='output/', verbose=True
):
